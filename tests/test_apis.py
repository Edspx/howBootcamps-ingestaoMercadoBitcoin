...
class TestDaySummaryApi:
    @pytest.mark.parametrize(
        "coin, date, expected",
        [
            ("BTC", datetime.date(2021, 11, 16), "https://www.mercadobitcoin.net/api/BTC/day-summary/2021/11/16"),
            ("ETH", datetime.date(2021, 11, 16), "https://www.mercadobitcoin.net/api/BTC/day-summary/2021/11/16"),
            ("ETH", datetime.date(2019, 1, 2), "https://www.mercadobitcoin.net/api/BTC/day-summary/2019/1/2"),
        ]
    )
...
class TestTradesApi:
    ...
    @pytest.mark.parametrize(
        "date, expected",
        [
            #print(int(datetime.datetime(2021, 6, 15).timestamp()))
