...
class Curriculo:
    ...
    def adcionar_experiencias(self, experiencias: str) -> None:
        self.experiencias.append(experiencias)
...
curriculo_andre = Curriculo(
    pessoa=andre, 
    experiencias=['HSBC', 'Polytech', 'Grupo Boticario', 'Olist', 'EmCasa', 'Gousto']
)

print(curriculo_andre)

curriculo_andre.adcionar_experiencias("How Education")
